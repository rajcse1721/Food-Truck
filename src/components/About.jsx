    ...
    <div className="bg-white text-black p-6 flex flex-col md:flex-row items-center justify-center gap-6">
      ...
      <div className="max-w-2xl">
        <p className="text-sm md:text-base leading-relaxed">
          ...
          seamless integration and performance tuning. I’m proficient in backend
          and frontend technologies, including React and SQL databases like
          MySQL. I have experience with build and deployment tools such as Maven
          and CI/CD pipelines using Jenkins. I enjoy solving real-world problems
          and building scalable, efficient software.
        </p>
      </div>
    </div>
